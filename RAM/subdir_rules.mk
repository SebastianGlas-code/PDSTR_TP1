...
build-1543199327: ../TP1_PDSTR.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccs2020/ccs/utils/sysconfig_1.25.0/sysconfig_cli.bat" --script "C:/Users/Silicium Lab/workspace_ccstheia/TP1_PDSTR/TP1_PDSTR.syscfg" -o "syscfg" -s "C:/ti/f29h85x-sdk_1_02_01_00/.metadata/sdk.json" -b "/boards/LAUNCHXL_F29H85X" --context "CPU1" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/board.c: build-1543199327 ../TP1_PDSTR.syscfg
syscfg/board.h: build-1543199327
syscfg/board.cmd.genlibs: build-1543199327
syscfg/peripheral_frame_mapping.h: build-1543199327
syscfg/interrupt_list.txt: build-1543199327
syscfg/errorevent_list.txt: build-1543199327
syscfg/pinmux.csv: build-1543199327
syscfg/device.c: build-1543199327
syscfg/device.h: build-1543199327
syscfg/ti_drivers_config.c: build-1543199327
syscfg/ti_drivers_config.h: build-1543199327
syscfg/clocktree.h: build-1543199327
syscfg/ti_dpl_config.c: build-1543199327
syscfg/ti_dpl_config.h: build-1543199327
syscfg: build-1543199327
